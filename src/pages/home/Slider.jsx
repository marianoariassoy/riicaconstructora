  ...
  return (
    <section id="home">
      {loading ? (
        ...
        <Slide indicators={indicators} {...properties} id="slide-home">
          {data.map((item, index) => (
            <SliderItem
              src={item.image}
              alt="Imagen presentación de Riica"
              opacity={1}
              key={index}
            />
          ))}
      ...
      <div className="social-media flex items-center justify-start opacity-0">
        <a
          href="https://www.facebook.com/riicaconstructora"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://www.instagram.com/riicaconstructora/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://www.linkedin.com/company/riicaconstructora"
          target="_blank"
          rel="noreferrer"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
      ...
      <div className="whatsapp z-30 opacity-0">
        <a href="https://wa.me/5493874685060" target="_blank" rel="noreferrer">
          <img
            ...
            alt="Whatsapp"
            className="drop-shadow-hover drop-shadow"
          />
        </a>
      </div>
    </section>
