  ...
  return (
    <section className="bg-secondary pt-24 lg:pb-24" id="novedades">
      <div className="container m-auto max-w-5xl p-10">
        ...
        <article className="novedades-item text-white mb-12 lg:flex justify-between gap-8 cursor-pointer hover:shadow-xl transition gs_reveal">
          ...
          <div className="novedades-item-txt lg:w-8/12 pt-4">
